...
const AdminDashboard = () => {
    ...
    return (
        <div>
            <div title="Dashboard" description="Admin Dashboard">
                <div className="row">
                    <div className="col-4">
                    <div className="card">
                        <div className="card-header">Danh mục</div>
                        <ul className="list-group">
                            <li className="list-group-item"><Link to="/admin/dashboard/product">Product</Link></li>
                            <li className="list-group-item"><Link to="/cart">Category</Link></li>
                        </ul>
                    </div>
                    </div>
                    <div className="col-8">
